module RingRouteUnitRTL__feefaee243610805
import cgra_pkg::*;
(
  input  logic [0:0] clk ,
  input  logic [8:0] pos ,
  ...
  logic [8:0] left_dist;
  logic [1:0] out_dir;
  logic [8:0] right_dist;
  IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d send_msg_wire;
  logic [2:0] send_rdy;
  ...
  always_comb begin : up_left_right_dist
    if ( recv__msg.dst < pos ) begin
      ...
      right_dist = ( ( 9'd256 - pos ) + recv__msg.dst ) + 9'd1;
    end
    else begin
      left_dist = ( ( 9'd1 + 9'd256 ) + pos ) - recv__msg.dst;
  ...
  always_comb begin : up_ru_routing
    ...
    if ( recv__val ) begin
      ...
      if ( ( pos == 9'd256 ) & ( out_dir == 2'( __const__RIGHT ) ) ) begin
        send_msg_wire.vc_id = 1'd1;
      end
      else if ( ( pos == 9'd0 ) & ( out_dir == 2'( __const__LEFT ) ) ) begin
        send_msg_wire.vc_id = 1'd1;
      end
