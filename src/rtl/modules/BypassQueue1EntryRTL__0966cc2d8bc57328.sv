module BypassQueue1EntryRTL__0966cc2d8bc57328
import cgra_pkg::*;
(
  input  logic [0:0] clk ,
  ...
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b entry;
  logic [0:0] full;
  //-------------------------------------------------------------
  ...
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b bypass_mux__in_ [0:1];
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b bypass_mux__out;
  logic [0:0] bypass_mux__reset;
  logic [0:0] bypass_mux__sel;

  Mux__029143f1c1a4c629 bypass_mux
  (
    .clk( bypass_mux__clk ),
    .in_( bypass_mux__in_ ),
    .out( bypass_mux__out ),
