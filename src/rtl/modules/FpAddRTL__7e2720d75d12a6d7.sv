module FpAddRTL__7e2720d75d12a6d7
import cgra_pkg::*;
(
  ...
  // At /WORK_REPO/CGRA-Flow/VectorCGRA/fu/float/FpAddRTL.py:55
  // s.fadd.subOp //= lambda: s.recv_opt.msg.operation == OPT_FSUB
  
  always_comb begin : _lambda__s_dut_tile_0__element_fu_4__fadd_subOp
    fadd__subOp = recv_opt__msg.operation == 7'( __const__OPT_FSUB );
  end

  // PyMTL Update Block Source
  // At /WORK_REPO/CGRA-Flow/VectorCGRA/fu/float/FpAddRTL.py:70
  //   @update
  //   def comb_logic():
  // 
  //     s.recv_all_val @= 0
