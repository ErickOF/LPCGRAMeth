module BypassQueueRTL__309dee5507394099
import cgra_pkg::*;
(
  input  logic [0:0] clk ,
  ...
  IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d dpath__recv_msg;
  logic [0:0] dpath__reset;
  IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d dpath__send_msg;
  logic [0:0] dpath__waddr;
  logic [0:0] dpath__wen;

  BypassQueueDpathRTL__309dee5507394099 dpath
  (
    .clk( dpath__clk ),
