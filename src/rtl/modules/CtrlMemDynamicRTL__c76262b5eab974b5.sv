module CtrlMemDynamicRTL__c76262b5eab974b5
import cgra_pkg::*;
(
  ...
  input IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d recv_pkt_from_controller__msg  ,
  ...
  output IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d send_pkt_to_controller__msg  ,
  ...
  localparam logic [8:0] __const__num_tiles_at_update_send_pkt_to_controller  = 9'd256;
  ...
  IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d recv_pkt_from_controller_queue__recv__msg;
  logic [0:0] recv_pkt_from_controller_queue__recv__rdy;
  logic [0:0] recv_pkt_from_controller_queue__recv__val;
  IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d recv_pkt_from_controller_queue__send__msg;
  logic [0:0] recv_pkt_from_controller_queue__send__rdy;
  logic [0:0] recv_pkt_from_controller_queue__send__val;

  NormalQueueRTL__309dee5507394099 recv_pkt_from_controller_queue
  (
  ...
  always_comb begin : update_send_pkt_to_controller
    ...
    send_pkt_to_controller__msg = { 9'd0, 9'( __const__num_tiles_at_update_send_pkt_to_controller ), 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 8'd0, 1'd0, { 5'( __const__CMD_COMPLETE ), 35'd0, 9'd0, 139'd0, 3'd0 } };
    recv_from_element_queue__send__rdy = 1'd0;
    if ( start_iterate_ctrl == 1'd1 ) begin
      if ( recv_from_element_queue__send__val & ( ~sent_complete ) ) begin
        send_pkt_to_controller__msg = { tile_id, 9'( __const__num_tiles_at_update_send_pkt_to_controller ), 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 8'd0, 1'd0, recv_from_element_queue__send__msg };
        ...
        if ( ( ( ( ~sent_complete ) & ( total_ctrl_steps_val > 11'd0 ) ) & ( times == total_ctrl_steps_val ) ) & start_iterate_ctrl ) begin
          send_pkt_to_controller__msg = { tile_id, 9'( __const__num_tiles_at_update_send_pkt_to_controller ), 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 8'd0, 1'd0, { 5'( __const__CMD_COMPLETE ), 35'd0, 9'd0, 139'd0, 3'd0 } };
          send_pkt_to_controller__val = 1'd1;
        end
      end
    end
