module NormalQueueRTL__5f2d19df340a1b0f
import cgra_pkg::*;
(
  input  logic [0:0] clk ,
  ...
  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 dpath__recv_msg;
  logic [0:0] dpath__reset;
  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 dpath__send_msg;
  logic [0:0] dpath__waddr;
  logic [0:0] dpath__wen;

  NormalQueueDpathRTL__5f2d19df340a1b0f dpath
  (
    .clk( dpath__clk ),
    .raddr( dpath__raddr ),
