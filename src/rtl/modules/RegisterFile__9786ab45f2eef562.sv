module RegisterFile__9786ab45f2eef562
import cgra_pkg::*;
(
  input  logic [0:0] clk ,
  input  logic [0:0] raddr [0:0],
  output MemAccessPacket_32_3_512__0e5e373c0405ceef rdata [0:0],
  input  logic [0:0] reset ,
  input  logic [0:0] waddr [0:0],
  input  MemAccessPacket_32_3_512__0e5e373c0405ceef wdata [0:0],
  ...
  MemAccessPacket_32_3_512__0e5e373c0405ceef regs [0:1];
