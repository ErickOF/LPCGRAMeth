module BypassQueueRTL__801671a65278f0b3
import cgra_pkg::*;
(
  input  logic [0:0] clk ,
  ...
  MemAccessPacket_3_32_512__62fa6e6064d885d7 dpath__recv_msg;
  logic [0:0] dpath__reset;
  MemAccessPacket_3_32_512__62fa6e6064d885d7 dpath__send_msg;
  logic [0:0] dpath__waddr;
  logic [0:0] dpath__wen;

  BypassQueueDpathRTL__801671a65278f0b3 dpath
  (
    .clk( dpath__clk ),
