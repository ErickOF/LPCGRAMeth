module ExclusiveDivRTL__a007a9f9d00e72b1
import cgra_pkg::*;
(
  ...
  // At /WORK_REPO/CGRA-Flow/VectorCGRA/fu/single/ExclusiveDivRTL.py:67
  // @update
  // def comb_logic():
  // 
  //   s.recv_all_val @= 0
  ...
  // PyMTL Update Block Source
  // At /WORK_REPO/CGRA-Flow/VectorCGRA/fu/single/ExclusiveDivRTL.py:54
  // @update_ff
  // def comb_ff():
