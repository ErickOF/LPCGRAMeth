module InputUnitRTL__82e0351e63c161b5
import cgra_pkg::*;
(
  input  logic [0:0] clk ,
  ...
  MemAccessPacket_32_3_512__0e5e373c0405ceef queue__recv__msg;
  logic [0:0] queue__recv__rdy;
  logic [0:0] queue__recv__val;
  MemAccessPacket_32_3_512__0e5e373c0405ceef queue__send__msg;
  logic [0:0] queue__send__rdy;
  logic [0:0] queue__send__val;

  BypassQueueRTL__8998ccae26c1d488 queue
  (
    .clk( queue__clk ),
    .count( queue__count ),
    .reset( queue__reset ),
