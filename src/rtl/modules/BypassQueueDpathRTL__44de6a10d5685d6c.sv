module BypassQueueDpathRTL__44de6a10d5685d6c
import cgra_pkg::*;
(
  input  logic [0:0] clk ,
  ...
  logic [0:0] mux__clk;
  MemAccessPacket_4_3_512__8e5c7af30d36e757 mux__in_ [0:1];
  MemAccessPacket_4_3_512__8e5c7af30d36e757 mux__out;
  logic [0:0] mux__reset;
  logic [0:0] mux__sel;

  Mux__Type_MemAccessPacket_4_3_512__8e5c7af30d36e757__ninputs_2 mux
  (
    .clk( mux__clk ),
    .in_( mux__in_ ),
    .out( mux__out ),
