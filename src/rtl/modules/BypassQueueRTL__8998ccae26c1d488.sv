module BypassQueueRTL__8998ccae26c1d488
import cgra_pkg::*;
(
  input  logic [0:0] clk ,
  ...
  MemAccessPacket_32_3_512__0e5e373c0405ceef dpath__recv_msg;
  logic [0:0] dpath__reset;
  MemAccessPacket_32_3_512__0e5e373c0405ceef dpath__send_msg;
  logic [0:0] dpath__waddr;
  logic [0:0] dpath__wen;

  BypassQueueDpathRTL__8998ccae26c1d488 dpath
  (
    .clk( dpath__clk ),
