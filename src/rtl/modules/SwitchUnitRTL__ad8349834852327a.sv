module SwitchUnitRTL__ad8349834852327a
import cgra_pkg::*;
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d recv__msg [0:5] ,
  ...
  logic [0:0] mux__clk;
  IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d mux__in_ [0:5];
  IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d mux__out;
  logic [0:0] mux__reset;
  logic [2:0] mux__sel;

  Mux__640111cddbd7ccca mux
  (
    .clk( mux__clk ),
    .in_( mux__in_ ),
    .out( mux__out ),
