module XbarRTL__387c2bc903b392a4
import cgra_pkg::*;
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 recv__msg [0:5] ,
  output logic [0:0] recv__rdy [0:5] ,
  input logic [0:0] recv__val [0:5] ,
  output ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 send__msg [0:0] ,
  ...
  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 input_units__recv__msg [0:5];
  logic [0:0] input_units__recv__rdy [0:5];
  logic [0:0] input_units__recv__val [0:5];
  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 input_units__send__msg [0:5];
  logic [0:0] input_units__send__rdy [0:5];
  logic [0:0] input_units__send__val [0:5];

  InputUnitRTL__8a91b11d7203ce5f input_units__0
  (
  ...
  InputUnitRTL__8a91b11d7203ce5f input_units__1
  (
  ...
  InputUnitRTL__8a91b11d7203ce5f input_units__2
  (
  ...
  InputUnitRTL__8a91b11d7203ce5f input_units__3
  (
  ...
  InputUnitRTL__8a91b11d7203ce5f input_units__4
  (
  ...
  InputUnitRTL__8a91b11d7203ce5f input_units__5
  (
  ...
  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 output_units__recv__msg [0:0];
  logic [0:0] output_units__recv__rdy [0:0];
  logic [0:0] output_units__recv__val [0:0];
  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 output_units__send__msg [0:0];
  logic [0:0] output_units__send__rdy [0:0];
  logic [0:0] output_units__send__val [0:0];

  OutputUnitRTL__4a4f552829f5844d output_units__0
  (
  ...
  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 route_units__recv__msg [0:5];
  logic [0:0] route_units__recv__rdy [0:5];
  logic [0:0] route_units__recv__val [0:5];
  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 route_units__send__msg [0:5][0:0];
  logic [0:0] route_units__send__rdy [0:5][0:0];
  logic [0:0] route_units__send__val [0:5][0:0];

  XbarRouteUnitRTL__541d468b12def23d route_units__0
  (
  ...
  XbarRouteUnitRTL__541d468b12def23d route_units__1
  (
  ...
  XbarRouteUnitRTL__541d468b12def23d route_units__2
  (
  ...
  XbarRouteUnitRTL__541d468b12def23d route_units__3
  (
  ...
  XbarRouteUnitRTL__541d468b12def23d route_units__4
  (
  ...
  XbarRouteUnitRTL__541d468b12def23d route_units__5
  (
  ...
  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 switch_units__recv__msg [0:0][0:5];
  logic [0:0] switch_units__recv__rdy [0:0][0:5];
  logic [0:0] switch_units__recv__val [0:0][0:5];
  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 switch_units__send__msg [0:0];
  logic [0:0] switch_units__send__rdy [0:0];
  logic [0:0] switch_units__send__val [0:0];

  SwitchUnitRTL__c8a0f69360b17a87 switch_units__0
  (
