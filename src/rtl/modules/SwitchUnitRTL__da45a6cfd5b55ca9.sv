module SwitchUnitRTL__da45a6cfd5b55ca9
import cgra_pkg::*;
(
  input  logic [0:0] clk ,
  ...
  logic [0:0] mux__clk;
  MemAccessPacket_3_4_512__8e5c7af30d36e757 mux__in_ [0:2];
  MemAccessPacket_3_4_512__8e5c7af30d36e757 mux__out;
  logic [0:0] mux__reset;
  logic [1:0] mux__sel;

  Mux__Type_MemAccessPacket_3_4_512__8e5c7af30d36e757__ninputs_3 mux
  (
    .clk( mux__clk ),
    .in_( mux__in_ ),
    .out( mux__out ),
