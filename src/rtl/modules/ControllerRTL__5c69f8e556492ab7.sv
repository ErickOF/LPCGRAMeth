module ControllerRTL__5c69f8e556492ab7
import cgra_pkg::*;
(
  input  logic [1:0] cgra_id ,
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d recv_from_cpu_pkt__msg  ,
  output logic [0:0] recv_from_cpu_pkt__rdy  ,
  input logic [0:0] recv_from_cpu_pkt__val  ,
  input IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d recv_from_ctrl_ring_pkt__msg  ,
  output logic [0:0] recv_from_ctrl_ring_pkt__rdy  ,
  input logic [0:0] recv_from_ctrl_ring_pkt__val  ,
  input InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b recv_from_inter_cgra_noc__msg  ,
  output logic [0:0] recv_from_inter_cgra_noc__rdy  ,
  input logic [0:0] recv_from_inter_cgra_noc__val  ,
  input InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b recv_from_tile_load_request_pkt__msg  ,
  output logic [0:0] recv_from_tile_load_request_pkt__rdy  ,
  input logic [0:0] recv_from_tile_load_request_pkt__val  ,
  input InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b recv_from_tile_load_response_pkt__msg  ,
  output logic [0:0] recv_from_tile_load_response_pkt__rdy  ,
  input logic [0:0] recv_from_tile_load_response_pkt__val  ,
  input InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b recv_from_tile_store_request_pkt__msg  ,
  output logic [0:0] recv_from_tile_store_request_pkt__rdy  ,
  input logic [0:0] recv_from_tile_store_request_pkt__val  ,
  output IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d send_to_cpu_pkt__msg  ,
  input logic [0:0] send_to_cpu_pkt__rdy  ,
  output logic [0:0] send_to_cpu_pkt__val  ,
  output IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d send_to_ctrl_ring_pkt__msg  ,
  input logic [0:0] send_to_ctrl_ring_pkt__rdy  ,
  output logic [0:0] send_to_ctrl_ring_pkt__val  ,
  output InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b send_to_inter_cgra_noc__msg  ,
  input logic [0:0] send_to_inter_cgra_noc__rdy  ,
  output logic [0:0] send_to_inter_cgra_noc__val  ,
  output InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b send_to_mem_load_request__msg  ,
  input logic [0:0] send_to_mem_load_request__rdy  ,
  output logic [0:0] send_to_mem_load_request__val  ,
  output InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b send_to_mem_store_request__msg  ,
  input logic [0:0] send_to_mem_store_request__rdy  ,
  output logic [0:0] send_to_mem_store_request__val  ,
  output InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b send_to_tile_load_response__msg  ,
  ...
  localparam logic [8:0] __const__num_tiles_at_update_received_msg  = 9'd256;
  ...
  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 crossbar__recv__msg [0:5];
  logic [0:0] crossbar__recv__rdy [0:5];
  logic [0:0] crossbar__recv__val [0:5];
  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 crossbar__send__msg [0:0];
  logic [0:0] crossbar__send__rdy [0:0];
  logic [0:0] crossbar__send__val [0:0];

  XbarRTL__387c2bc903b392a4 crossbar
  (
    .clk( crossbar__clk ),
  ...
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b global_reduce_unit__recv_count__msg;
  logic [0:0] global_reduce_unit__recv_count__rdy;
  logic [0:0] global_reduce_unit__recv_count__val;
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b global_reduce_unit__recv_data__msg;
  logic [0:0] global_reduce_unit__recv_data__rdy;
  logic [0:0] global_reduce_unit__recv_data__val;
  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 global_reduce_unit__send__msg;
  logic [0:0] global_reduce_unit__send__rdy;
  logic [0:0] global_reduce_unit__send__val;

  GlobalReduceUnitRTL__6f81a9119116661f global_reduce_unit
  (
  ...
  IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d recv_from_cpu_pkt_queue__recv__msg;
  logic [0:0] recv_from_cpu_pkt_queue__recv__rdy;
  logic [0:0] recv_from_cpu_pkt_queue__recv__val;
  IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d recv_from_cpu_pkt_queue__send__msg;
  logic [0:0] recv_from_cpu_pkt_queue__send__rdy;
  logic [0:0] recv_from_cpu_pkt_queue__send__val;

  NormalQueueRTL__309dee5507394099 recv_from_cpu_pkt_queue
  (
  ...
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b recv_from_tile_load_request_pkt_queue__recv__msg;
  logic [0:0] recv_from_tile_load_request_pkt_queue__recv__rdy;
  logic [0:0] recv_from_tile_load_request_pkt_queue__recv__val;
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b recv_from_tile_load_request_pkt_queue__send__msg;
  logic [0:0] recv_from_tile_load_request_pkt_queue__send__rdy;
  logic [0:0] recv_from_tile_load_request_pkt_queue__send__val;

  ChannelRTL__974ab9d5aef5af27 recv_from_tile_load_request_pkt_queue
  (
  ...
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b recv_from_tile_load_response_pkt_queue__recv__msg;
  logic [0:0] recv_from_tile_load_response_pkt_queue__recv__rdy;
  logic [0:0] recv_from_tile_load_response_pkt_queue__recv__val;
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b recv_from_tile_load_response_pkt_queue__send__msg;
  logic [0:0] recv_from_tile_load_response_pkt_queue__send__rdy;
  logic [0:0] recv_from_tile_load_response_pkt_queue__send__val;

  ChannelRTL__974ab9d5aef5af27 recv_from_tile_load_response_pkt_queue
  (
  ...
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b recv_from_tile_store_request_pkt_queue__recv__msg;
  logic [0:0] recv_from_tile_store_request_pkt_queue__recv__rdy;
  logic [0:0] recv_from_tile_store_request_pkt_queue__recv__val;
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b recv_from_tile_store_request_pkt_queue__send__msg;
  logic [0:0] recv_from_tile_store_request_pkt_queue__send__rdy;
  logic [0:0] recv_from_tile_store_request_pkt_queue__send__val;

  ChannelRTL__974ab9d5aef5af27 recv_from_tile_store_request_pkt_queue
  (
  ...
  IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d send_to_cpu_pkt_queue__recv__msg;
  logic [0:0] send_to_cpu_pkt_queue__recv__rdy;
  logic [0:0] send_to_cpu_pkt_queue__recv__val;
  IntraCgraPacket_4_4x1_256_8_2_CgraPayload__7c76b76106625f8d send_to_cpu_pkt_queue__send__msg;
  logic [0:0] send_to_cpu_pkt_queue__send__rdy;
  logic [0:0] send_to_cpu_pkt_queue__send__val;

  NormalQueueRTL__309dee5507394099 send_to_cpu_pkt_queue
  (
  ...
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b send_to_mem_load_request_queue__recv__msg;
  logic [0:0] send_to_mem_load_request_queue__recv__rdy;
  logic [0:0] send_to_mem_load_request_queue__recv__val;
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b send_to_mem_load_request_queue__send__msg;
  logic [0:0] send_to_mem_load_request_queue__send__rdy;
  logic [0:0] send_to_mem_load_request_queue__send__val;

  ChannelRTL__974ab9d5aef5af27 send_to_mem_load_request_queue
  (
  ...
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b send_to_mem_store_request_queue__recv__msg;
  logic [0:0] send_to_mem_store_request_queue__recv__rdy;
  logic [0:0] send_to_mem_store_request_queue__recv__val;
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b send_to_mem_store_request_queue__send__msg;
  logic [0:0] send_to_mem_store_request_queue__send__rdy;
  logic [0:0] send_to_mem_store_request_queue__send__val;

  ChannelRTL__974ab9d5aef5af27 send_to_mem_store_request_queue
  (
  ...
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b send_to_tile_load_response_queue__recv__msg;
  logic [0:0] send_to_tile_load_response_queue__recv__rdy;
  logic [0:0] send_to_tile_load_response_queue__recv__val;
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b send_to_tile_load_response_queue__send__msg;
  logic [0:0] send_to_tile_load_response_queue__send__rdy;
  logic [0:0] send_to_tile_load_response_queue__send__val;

  ChannelRTL__974ab9d5aef5af27 send_to_tile_load_response_queue
  (
  ...
  InterCgraPacket_4_4x1_256_8_4_CgraPayload__0bc91b9c3f724b0b __tmpvar__update_received_msg_received_pkt;
  ...
  always_comb begin : update_received_msg
    ...
    send_to_cpu_pkt_queue__recv__msg = { 9'd0, 9'd0, 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 8'd0, 1'd0, 191'd0 };
    ...
    for ( int unsigned i = 1'd0; i < 3'( __const__CONTROLLER_CROSSBAR_INPORTS ); i += 1'd1 ) begin
      ...
      crossbar__recv__msg[3'(i)] = { 1'd0, 234'd0 };
    end
    ...
    crossbar__recv__msg[__tmpvar__update_received_msg_kFromInterTileRingIdx] = { 1'd0, { cgra_id, recv_from_ctrl_ring_pkt__msg.dst_cgra_id, idTo2d_x_lut[cgra_id], idTo2d_y_lut[cgra_id], recv_from_ctrl_ring_pkt__msg.dst_cgra_x, recv_from_ctrl_ring_pkt__msg.dst_cgra_y, recv_from_ctrl_ring_pkt__msg.src, recv_from_ctrl_ring_pkt__msg.dst, 5'd0, 8'd0, 2'd0, recv_from_ctrl_ring_pkt__msg.payload } };
    ...
    crossbar__recv__msg[__tmpvar__update_received_msg_kFromCpuCtrlAndDataIdx] = { 1'd0, { cgra_id, recv_from_cpu_pkt_queue__send__msg.dst_cgra_id, 2'd0, 1'd0, idTo2d_x_lut[recv_from_cpu_pkt_queue__send__msg.dst_cgra_id], idTo2d_y_lut[recv_from_cpu_pkt_queue__send__msg.dst_cgra_id], 9'( __const__num_tiles_at_update_received_msg ), recv_from_cpu_pkt_queue__send__msg.dst, 5'd0, 8'd0, 2'd0, recv_from_cpu_pkt_queue__send__msg.payload } };
    ...
    send_to_mem_load_request_queue__recv__msg = { 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 9'd0, 9'd0, 5'd0, 8'd0, 2'd0, 191'd0 };
    send_to_mem_store_request_queue__recv__msg = { 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 9'd0, 9'd0, 5'd0, 8'd0, 2'd0, 191'd0 };
    send_to_tile_load_response_queue__recv__msg = { 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 9'd0, 9'd0, 5'd0, 8'd0, 2'd0, 191'd0 };
    recv_from_inter_cgra_noc__rdy = 1'd0;
    send_to_ctrl_ring_pkt__val = 1'd0;
    send_to_ctrl_ring_pkt__msg = { 9'd0, 9'd0, 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 8'd0, 1'd0, 191'd0 };
    global_reduce_unit__recv_count__val = 1'd0;
    global_reduce_unit__recv_count__msg = { 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 9'd0, 9'd0, 5'd0, 8'd0, 2'd0, 191'd0 };
    global_reduce_unit__recv_data__val = 1'd0;
    global_reduce_unit__recv_data__msg = { 2'd0, 2'd0, 2'd0, 1'd0, 2'd0, 1'd0, 9'd0, 9'd0, 5'd0, 8'd0, 2'd0, 191'd0 };
    ...
    if ( recv_from_inter_cgra_noc__val ) begin
      if ( recv_from_inter_cgra_noc__msg.payload.cmd == 5'( __const__CMD_LOAD_REQUEST ) ) begin
        ...
        if ( recv_from_inter_cgra_noc__msg.dst_tile_id == 9'( __const__num_tiles_at_update_received_msg ) ) begin
