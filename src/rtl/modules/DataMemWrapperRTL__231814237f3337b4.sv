module DataMemWrapperRTL__231814237f3337b4
import cgra_pkg::*;
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input MemAccessPacket_32_3_512__0e5e373c0405ceef recv_rd__msg  ,
  output logic [0:0] recv_rd__rdy  ,
  input logic [0:0] recv_rd__val  ,
  input MemAccessPacket_32_3_512__0e5e373c0405ceef recv_wr__msg  ,
  ...
  MemAccessPacket_32_3_512__0e5e373c0405ceef streaming_rd_read_reqeust;
  ...
  MemAccessPacket_32_3_512__0e5e373c0405ceef channel_rd__recv__msg;
  logic [0:0] channel_rd__recv__rdy;
  logic [0:0] channel_rd__recv__val;
  MemAccessPacket_32_3_512__0e5e373c0405ceef channel_rd__send__msg;
  logic [0:0] channel_rd__send__rdy;
  logic [0:0] channel_rd__send__val;

  ChannelRTL__91cc029d3b0c57f8 channel_rd
  (
    .clk( channel_rd__clk ),
  ...
  MemAccessPacket_32_3_512__0e5e373c0405ceef channel_wr__recv__msg;
  logic [0:0] channel_wr__recv__rdy;
  logic [0:0] channel_wr__recv__val;
  MemAccessPacket_32_3_512__0e5e373c0405ceef channel_wr__send__msg;
  logic [0:0] channel_wr__send__rdy;
  logic [0:0] channel_wr__send__val;

  ChannelRTL__91cc029d3b0c57f8 channel_wr
  (
    .clk( channel_wr__clk ),
  ...
  always_comb begin : compose_send_msg
    send__msg = { 2'd0, 5'd0, 9'd0, { 32'd0, 1'd0, 1'd0, 1'd0 }, 2'd0, 9'd0, 5'd0, 1'd0, 9'd0, 9'd0 };
  ...
  always_ff @(posedge clk) begin : update_streaming_rd_regs
    if ( channel_rd__send__val & channel_rd__send__msg.streaming_rd ) begin
      ...
      streaming_rd_read_reqeust <= { 5'd0, 2'd0, 9'd0, { 32'd0, 1'd0, 1'd0, 1'd0 }, 2'd0, 9'd0, 5'd0, 1'd0, 9'd0, 9'd0 };
    end
    else
