module RegisterFile__fc6bf454ec3d52a7
import cgra_pkg::*;
(
  input  logic [0:0] clk ,
  input  logic [0:0] raddr [0:0],
  output ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 rdata [0:0],
  input  logic [0:0] reset ,
  input  logic [0:0] waddr [0:0],
  input  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 wdata [0:0],
  ...
  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 regs [0:1];
