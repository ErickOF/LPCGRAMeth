module SwitchUnitRTL__c8a0f69360b17a87
import cgra_pkg::*;
(
  input  logic [0:0] clk ,
  ...
  logic [0:0] mux__clk;
  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 mux__in_ [0:5];
  ControllerNocXbarPacket_InterCgraPktType__4cecb651ad7cb757 mux__out;
  logic [0:0] mux__reset;
  logic [2:0] mux__sel;

  Mux__02de6acae753f051 mux
  (
    .clk( mux__clk ),
    .in_( mux__in_ ),
    .out( mux__out ),
