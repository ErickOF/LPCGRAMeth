module BypassQueueRTL__2b281fcf94e1f0c3
import cgra_pkg::*;
(
  input  logic [0:0] clk ,
  ...
  MemAccessPacket_3_4_512__8e5c7af30d36e757 dpath__recv_msg;
  logic [0:0] dpath__reset;
  MemAccessPacket_3_4_512__8e5c7af30d36e757 dpath__send_msg;
  logic [0:0] dpath__waddr;
  logic [0:0] dpath__wen;

  BypassQueueDpathRTL__2b281fcf94e1f0c3 dpath
  (
    .clk( dpath__clk ),
